...
c WRITE(25,*) 'zone T = "U(r)"'
          ...
          DM1(1,1)=-(1.D0/(3.D0*RDIST**3)+M1/(De*6.D0*RDIST**6))
          DM1(1,2)=(SQRT(2.D0)/6.D0)*(M1/(De*RDIST**6)+2/RDIST**3)
          DM1(1,3)=SQRT(6.D0)/(6.D0*RDIST**3)
          DM1(2,1)=DM1(1,2)
          DM1(2,2)=-2.D0/(3.D0*RDIST**3)-M1/(3.D0*De*RDIST**6)
       ...
       DR(1,1)=(3.D0*M1*RDIST**5+6*M2*RDIST**2+8*M5)/(3.D0*RDIST**9)
       DR(1,2)=-SQRT(2.D0)*DR(1,1)
